// ./params/vision.dev.bicepparam
// Self-contained parameter file for deploying vision.bicep in a dev environment.
// Configured for the Free tier (F0) and specific Managed Identity.

using '../modules/vision.bicep' // Relative path to the bicep module file

// --- Parameters explicitly defined in this file ---

@description('Azure region where the Vision service will be created.')
param location = 'westeurope' // Define the specific location

@description('Prefix used for generating the Vision service name.')
...
@description('The SKU for the Vision service.')
